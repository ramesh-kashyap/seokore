...
<head>
    <meta charset="utf-8">
    <title>GenIq - Step Into the Future of Trading</title>
...
<body class="mein_cn">
                ...
                <div data-v-b73557e2="" data-v-366decca="" class="head head_isModule" data-v-6e2d35de="">
                    ...
                    <div data-v-b73557e2="" class="container flex"><!---->
                        ...
                        <div data-v-b73557e2="" class="lang"><img data-v-b73557e2=""
                                ...
                                alt=""></div>
                        <div data-v-b73557e2="" class="notice">  <a href="https://t.me/luxboticaa" target="_blank"> 
                    ...
                    <div data-v-366decca="" data-v-6e2d35de="" class="container">
                        <div data-v-366decca="" data-v-6e2d35de="" class="logo flex">
                            <div data-v-366decca="" data-v-6e2d35de="" class="icon"><img data-v-366decca=""
                                    data-v-6e2d35de="" src="{{ asset('') }}static/img/logo2.png" alt="">
                            </div>
                            <div data-v-366decca="" data-v-6e2d35de="" class="flex1">
                                <div data-v-366decca="" data-v-6e2d35de="" class="n">Hello,</div>
                                <div data-v-366decca="" data-v-6e2d35de="" class="s">Welcome
                                    {{ siteName() }}</div>
                            </div>
                        </div>
                                ...
                                <div data-v-366decca="" data-v-6e2d35de="" class="it">
                                    ...
                                    <div data-v-366decca="" data-v-6e2d35de="" class="val flex inp">
                                        <div data-v-39429002="" class="set_area" class="phone_code" id="phone_code"
                                            ...
                                            <img data-v-afb5025a="" class="icon"
                                                style="filter: brightness(0) saturate(100%) invert(100%) sepia(0%) saturate(7500%) hue-rotate(245deg) brightness(104%) contrast(104%);padding-right: 10px;"
    ...
    <div class="van-toast van-toast--middle van-toast--text" id="customErrorToast" style="z-index: 2005; display: none;">
    <div class="van-toast__text" id="customErrorToastText">Exit successfully</div>
</div>
</body>
