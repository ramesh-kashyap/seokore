...
ul li::before {
  ...
  left: 0;
  top: 0;
  color: #10e1cc; /* Match your green theme */
  font-weight: bold;
  font-size: 14px;
}
.bg[data-v-b01bcdbc] {
                        ...
                        <div data-v-b01bcdbc="" data-v-6e2d35de="" class="item">
                            <div data-v-b01bcdbc="" data-v-6e2d35de="" class="p">
                                ...
                                <div style="color: #ffffff; font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; line-height: 1.6;">
                                    ...
                                    <h2 style="color: #10e1cc;">{{siteName()}} Overview</h2>
                                    <p>
                                        GeniQ is a next-generation auto trading platform powered by cutting-edge AI technology, designed to simplify and supercharge your investment journey. Our mission is to provide accessible, automated, and intelligent trading solutions for everyone — from beginners to pro-level investors.
                                    </p>
                                    <p>
                                        We believe that financial freedom shouldn’t be complicated. That’s why GeniQ offers a 100% passive income system, delivering daily trading profits, a powerful referral network, and transparent growth opportunities — all with minimal effort and maximum results.

                                    </p>
                                  
                                    <hr style="border: none; border-top: 1px solid #444; margin: 30px 0;" />
                                  
                                    <h3 style="color: #10e1cc;"> What Makes GeniQ Different?</h3>
                                  
                                    <ul style="padding-left:5px;">
                                      <li>AI-Powered Trading Engine – Executes smart trades daily for consistent returns</li>
                                      <li> Daily Profits – Earn from 1.8% to 3.0% depending on your VIP level</li>
                                      <li>Global Team Growth – Unlock higher packages and bonuses through referrals</li>
                                      <li>Secure & Instant Withdrawals – Your funds, when you need them</li>
                                      <li>Scalable Investment Packages – Choose your level, upgrade anytime</li>
                                    </ul>
                                  
                                    <hr style="border: none; border-top: 1px solid #444; margin: 30px 0;" />
                                  
                                    <h3 style="color: #10e1cc;">Our Vision</h3>
                                    <p>
                                      At {{siteName()}}, we integrate advanced data analytics, automation tools, and behavioral targeting systems to drive consistent results for clients. Our proprietary delegation technology ensures campaigns are delivered with precision, while real-time feedback loops help optimize spend, engagement, and performance.
                                    </p>
                                    <p>
                                    ...
                                    <h3 style="color: #10e1cc;">Our Goal</h3>
                                    <p>
                                      {{siteName()}} aims to redefine digital performance standards by offering transparent, tech-enabled, and result-driven marketing delegation. Whether through campaign management, traffic services, or engagement mechanics, our focus is on scalability, reliability, and results.
                                    </p>
                                    <p>
                                    ...
                                    <h3 style="color: #10e1cc;">More Info</h3>
                                    <p>
                                      For more information, please refer to the official document:
                                      <a href="#" target="_blank" style="color: #10e1cc;">www.geniqtrade.com</a>
                                    </p>
