                    ...
                    <div data-v-6e2d35de="" id="content" class="content-scroll">
                        <div data-v-73b46d99="" data-v-6e2d35de="" class="container">
                            <div id="dateFilterPopup"
                                style="display:none; background: rgb(17 18 22); padding: 20px; border-radius: 12px; position: fixed; top: 20%; left: 50%; transform: translateX(-50%); width: 90%; max-width: 400px; z-index: 999; box-shadow: rgb(0 0 0) 0px 10px 25px;">
                                <div
                                    style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                                    <h3 style="margin: 0; font-size: 18px; font-weight: bold;color:#fff">Select Date
                                        Range</h3>
                                    <button onclick="document.getElementById('dateFilterPopup').style.display='none'"
                                        style="border: none; background: transparent; font-size: 20px; cursor: pointer;color:#fff">&times;</button>
                                </div>

                                <form method="GET" action="{{ route('user.records') }}">
                                    <div style="margin-bottom: 15px;">
                                        <label
                                            style="display:block; font-size: 14px; margin-bottom: 5px;color:#fff">Start
                                            Date</label>
                                        <input type="date" name="start_date" required
                                            style="width: 100%; padding: 10px; border: 1px solid #403d3d; border-radius: 6px;background-color: #0f0e11;color:#929292">
                                    </div>

                                    <div style="margin-bottom: 15px;">
                                        <label
                                            style="display:block; font-size: 14px; margin-bottom: 5px;color:#fff">End
                                            Date</label>
                                    ...
                                    <div style="display: flex; justify-content: flex-end; gap: 10px;">
                                        <button type="submit"
                                            style="padding: 8px 16px; border: none; border-radius: 5px; background-color: #28a745; color: white; font-weight: bold; cursor: pointer;">Apply</button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <ul data-v-73b46d99="" data-v-6e2d35de="" class="setList">
                                <li data-v-73b46d99="" data-v-6e2d35de="" id="openPopupBtn"> All <img
                                        data-v-73b46d99="" data-v-6e2d35de=""
                                        src="{{ asset('') }}static/img/bb.png" alt="">

                                </li>
                                <li id="openDateFilter" data-v-73b46d99="" data-v-6e2d35de=""><span
                                        data-v-73b46d99="" data-v-6e2d35de="">time</span><img data-v-73b46d99=""
                                        data-v-6e2d35de="" src="{{ asset('') }}static/img/bb.png"
                                        alt=""></li>
                            </ul>
                            <!---->
                                            ...
                                            @foreach ($deposit_list as $value)
                                                <li data-v-8b8e62ac="">
                                                    ...
                                                    <div data-v-8b8e62ac="" class="flex">
                                                        ...
                                                        <div data-v-8b8e62ac="" class="amount">{{ $value->amount }}
                                                            USDT</div>
                                                    </div>
                                                    <div data-v-8b8e62ac="" class="flex">
                                                        <div data-v-8b8e62ac="" class="time">
                                                            {{ date('D, d M Y H:i:s', strtotime($value->created_at)) }}
                                                        </div>
                                                        <div data-v-8b8e62ac="" class="str"><span
                                                                data-v-8b8e62ac="" class="s1"></span>
                        ...
                        <div data-v-554f6835="" data-v-73b46d99="" data-v-6e2d35de="">
                            ...
                            <!-- Popup Box -->
                            <div id="popupContainer" data-v-554f6835=""
                                ...
                                <div data-v-554f6835="" class="popup_box">
                                    <div data-v-554f6835="" class="scroll">
                                        <div data-v-554f6835="" class="ul">
                                            <div data-v-554f6835="">
                                                <div data-v-554f6835="" class="item"> <a
                                                        href="{{ 'roi-bonus' }}">Income<a></div>
                                            </div>


                                            <div data-v-554f6835="">
                                                <div data-v-554f6835="" class="item"> <a
                                                        href="{{ 'record' }}">Deposit</a></div>
                                            </div>
                                            <div data-v-554f6835="">
                                                <div data-v-554f6835="" class="item"> <a
                                                        href="{{ 'WithdrawHistory' }}">Withdrawal</a></div>
                                            </div>


                                        </div>
                                    </div>
                                    <div data-v-554f6835="" class="esc" id="closePopupBtn" style="color:white;">
                                        Cancel</div>
                                </div>
                            </div>
                        </div>
