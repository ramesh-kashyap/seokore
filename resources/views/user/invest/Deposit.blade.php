...
<body class="mein_cn">
    <div id="app" class="applang">
        <div data-v-6e2d35de="" data-v-679886a1="" class="page">
            <div data-v-6e2d35de="" class="headers">
                <div data-v-b73557e2="" data-v-679886a1="" class="head" style="background: #0f0e11"
                    data-v-6e2d35de="">
                    ...
                    <div data-v-b73557e2="" class="container flex">
                        ...
                        <!---->
                        <!---->
                        <div data-v-b73557e2="" class="head_right"><a href="{{ route('user.records') }}"><img
                                    data-v-679886a1="" data-v-b73557e2=""
                                    src="{{ asset('') }}static/img/invest.png" alt=""
                                    class="headRight"></a></div>
                    </div>
                    <div data-v-b73557e2="">
                        <!---->
                    </div>
                ...
                <div data-v-6e2d35de="" id="content" class="content-scroll">
                    <div data-v-679886a1="" data-v-6e2d35de="" class="container">
                        ...
                        <div data-v-679886a1="" data-v-887483d6="" class="item valMob">
                            <div data-v-679886a1="" data-v-887483d6="" class="cname" style="color:white;">Select
                                Network
                            </div>
                            <div data-v-679886a1="" data-v-887483d6="" class="inp">
                                <div data-v-679886a1="" data-v-887483d6="" class="icon"><img data-v-679886a1=""
                                        data-v-887483d6="" id="currencyImg"
                                        src="https://tux-all.s3.ap-southeast-1.amazonaws.com/upload/20240723/284411f22a828b42a327a5a8586fae88.png"
                                        alt=""></div>



                                <input data-v-679886a1="" data-v-887483d6="" id="currencyId" style="color:white;"
                                    Value="BEP20" readonly type="text" >
                                <div data-v-679886a1="" data-v-887483d6="" class="arr" ><img
                                        data-v-679886a1="" data-v-887483d6=""
                        ...
                        <div data-v-679886a1="" data-v-6e2d35de="" class="itemBox">
                            <div data-v-679886a1="" data-v-6e2d35de="" class="mbox">
                                <div data-v-679886a1="" data-v-6e2d35de="" id="qrcode"
                                    title="{{ $address_in }}"><canvas width="185" height="185"
                                        style="display: none;"></canvas><img alt="Scan me!"
                                        src="{{ $qrCodeLink }}" id="qrCodeImage"></div>

                            </div>
                            <div data-v-679886a1="" data-v-6e2d35de="" class="mtext"> @lang('QR CODE')</div>
                        </div>
                        <div data-v-679886a1="" data-v-6e2d35de="" class="valMob">
                            <div data-v-679886a1="" data-v-6e2d35de="" class="cname">@lang('Deposit Address')</div>
                            <div data-v-679886a1="" data-v-6e2d35de="" class="inp" style="background: #0f0e11">
                                <div data-v-679886a1="" data-v-6e2d35de="" class="address_text"
                                    id="depositAddressDiv">
                                    {{ $address_in }}</div>
                                <div data-v-679886a1="" data-v-6e2d35de="" class="copy-btn">
                        ...
                        <div data-v-679886a1="" data-v-6e2d35de="" class="itemBox">
                            <div data-v-58b133cc="" data-v-679886a1="" class="tips">
                                <div data-v-58b133cc="" class="p">
                                    <div style="background-color: transparent; color: #ff4d4f; margin-top: 16px; border-radius: 8px;">
                                      <strong>⚠️ Important Deposit Rules:</strong>
                                      <ul style="margin-top: 8px; padding-left: 20px; font-size: 14px; color: #fff;">
                                        <li>We only accept <strong>USDT via the BEP20 (Binance Smart Chain)</strong> network.</li>
                                        <li><strong>Do NOT send USDT using TRC20, ERC20, or any other network.</strong></li>
                                        <li>Sending from the wrong network may result in <strong>permanent loss of your funds</strong>.</li>
                                        <li>Always double-check the selected network before confirming your transfer.</li>
                                      </ul>
                                    </div>
        ...
        <div data-v-a7d12cfc="" class="global-loading default" id="global-loading" style="display: none;">
    ...
    <div data-v-28f4094c="" data-v-679886a1="" id="popupBox"
        class="popup van-popup van-popup--round van-popup--bottom" style="z-index: 2004; display: none;">
            ...
            <div data-v-28f4094c="" class="coins">
                <div data-v-28f4094c="" class="van-tabs van-tabs--line">
                    ...
                    <div data-v-28f4094c="" class="chains">
                         <div data-v-28f4094c="" class="item on" onclick="selectChain(this)" data-coin="USDT_BSC">
                            ...
                            <div data-v-28f4094c="" class="check" style="display:block;">
                                <img data-v-28f4094c=""
                    ...
                    <div class="van-tabs__content">
                        ...
                        </div><button data-v-28f4094c="" class="btn2" onclick="confirmSelectedChain()"> Confirm
                        </button>
                    </div>
    ...
    <div class="van-toast van-toast--middle van-toast--success" style="z-index: 2015; display: none;">
