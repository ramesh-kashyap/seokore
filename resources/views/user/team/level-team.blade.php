                        ...
                        <div data-v-127dfd5e="" data-v-6e2d35de="" class="container rel">
                            ...
                            ">
                                <ul data-v-5105ae1a="" class="flex">
                                    <li data-v-5105ae1a="">
                                        <div data-v-5105ae1a="" class="title">@lang('Total Team')</div>
                                        <div data-v-5105ae1a="" class="val">{{$tatalActive}}/{{$totalTeam}}
                                        </div>
                                    </li>
                                    <li data-v-5105ae1a="">
                                        <div data-v-5105ae1a="" class="title">@lang('Total Earn')</div>
                                        <div data-v-5105ae1a="" class="val">${{number_format($teamEarning,2)}}</div>
                                    </li>
                                    <li data-v-5105ae1a="">
                                        <div data-v-5105ae1a="" class="title">@lang('Total Deposits')</div>
                                ...
                                {{-- <button data-v-5105ae1a="" class="btn2"
                                    style=" background: #00fefb;"> <a
