                ...
                <div data-v-6b868a30="" id="content" class="content-scroll">
                    <div data-v-2be00b70="" data-v-6b868a30="" class="tw-min-h-full tw-p-16px">
                        <div data-v-2be00b70="" data-v-6b868a30="" class="tw-p-16px tw-bg-white3 tw-rounded-10px">
                            <p><strong>SEOKORE Company Terms of Use</strong></p>

                            <p>Welcome to use SEOKORE's products and services! We are well aware of the importance of
                            ...
                            <p><strong>SEOKORE business operation rules are summarized as follows:</strong></p>

                            <p><strong>Age requirements</strong></p>

                            <ul>
                                <li>SEOKORE users must be over 18 years old. </li>
                                <li>When using SEOKORE services, users must fully agree and accept SEOKORE's business
                                    operating rules. </li>
                            </ul>
                            ...
                            <ul>
                                <li>On the SEOKORE platform, basic services involve account creation and management.
                                </li>
                                <li>To create a SEOKORE account, you need to provide your mobile phone number, member
                            ...
                            <ul>
                                ...
                                <li>For users who already have accounts, their personal information, offers and orders
                                    may be displayed on the SEOKORE platform. </li>
                                <li>Respect users’ personal setting choices on the SEOKORE platform. </li>
                            </ul>
                            ...
                            <ul>
                                <li>SEOKORE reserves the right to modify the business rules when necessary. </li>
                                <li>If business operation rules change, SEOKORE will prompt users to make changes on
                                    important pages. </li>
                            ...
                            <ul>
                                <li>SEOKORE provides strategic order operations, related information and online payment
                            ...
                            <ul>
                                <li>SEOKORE is committed to maintaining the confidentiality of user registration
                                ...
                                <li>Users should contact SEOKORE immediately when discovering illegal use or security
                                    vulnerabilities. </li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>SEOKORE does not bear legal responsibility for abnormal situations caused by users
                                    themselves. </li>
                            </ul>
                            ...
                            <ul>
                                <li>The SEOKORE system will strictly review funds to ensure the safety of user funds.
                                </li>
                            </ul>
                            ...
                            <ul>
                                <li>SEOKORE will take legal measures to protect the legitimate rights and interests of
                            ...
                            <ul>
                                <li>SEOKORE has the final right to interpret all terms and content. </li>
                            </ul>

                            <p><strong>Prohibitions</strong></p>

                            <ul>
                                <li>Malicious use of multiple SEOKORE accounts is prohibited. </li>
                                <li>It is prohibited to maliciously waste company resources. </li>
                                <li>Theft of company and user assets is prohibited. </li>
                                <li>Impersonating SEOKORE officials and defaming SEOKORE is prohibited. </li>
                            </ul>

                            <p><strong>Information technology support service specifications</strong></p>

                            <ul>
                                <li>SEOKORE carries out user information technology support service survey activities to
                                    improve user experience and service quality. </li>
                                <li>Users can provide suggestions and feedback in a variety of ways. </li>
                                <li>SEOKORE will actively pay attention to user feedback and complaints and provide
                                    solutions. </li>
                            ...
                            <p>In order to enhance user experience and improve product quality and service levels,
                                SEOKORE carries out user information technology support service survey activities. Users
                                can make suggestions in a variety of ways, including Telegram, Whatsapp email, SMS, etc.
                                SEOKORE will actively pay attention to user feedback and complaints and provide
                                ...
                                clarify the user service scope of the SEOKORE platform and ensure that users understand
                                their rights and obligations during use. We encourage users to read these rules
                                carefully to better understand and utilize the services of the SEOKORE platform. </p>

                            <p><strong>SEOKORE has the final right to interpret all the above terms and content.
                                </strong></p>
                        </div>
                    </div>
                </div>
